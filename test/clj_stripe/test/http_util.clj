...
(test/deftest test-set-tokens!
  ...
  (test/is (= (set-tokens! {:private "privater"}) {:private "privater" :public "public"}))
  (test/is (= (set-tokens! {:public "publicer"})) {:private "privater" :public "publicer"})
  (test/is (= (set-tokens! {}) {:private "privater" :public "publicer"})))
